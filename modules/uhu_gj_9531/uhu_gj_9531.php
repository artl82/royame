...
class Uhu_gj_9531 extends Module
{

	public function __construct()
	{
		$this->name = 'uhu_gj_9531';
		$this->tab = 'others';
		...
		$this->displayName = 'uhu Advertising block 9531';
		$this->description = $this->l('Adds a block to display three advertisements.');
	}
	...
	public function hookHome($params)
	{
		...
		$this->smarty->assign(array(
			...
			'zoom' => Configuration::get('uhu_modvalue_'.$mod_name.'_11')
		));
		...
		{
			if (isset($_COOKIE['gj9531']))
			{
				if($_COOKIE['gj9531'] == 'show')
