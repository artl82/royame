...
class Uhu_gj_9541 extends Module
{

	public function __construct()
	{
		$this->name = 'uhu_gj_9541';
		$this->tab = 'others';
		...
		$this->displayName = 'uhu Advertising block 9541';
		$this->description = $this->l('Adds a block to display four advertisements.');
	}
	...
	public function hookHome($params)
	{
		...
		{
			if (isset($_COOKIE['gj9541']))
			{
				if($_COOKIE['gj9541'] == 'show')
