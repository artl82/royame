...
class Uhu_gj_9551 extends Module
{

	public function __construct()
	{
		$this->name = 'uhu_gj_9551';
		$this->tab = 'others';
		...
		$this->displayName = 'uhu Advertising block 9551';
		$this->description = $this->l('Adds a block to display five advertisements.');
	}
	...
	public function hookHome($params)
	{
		...
		{
			if (isset($_COOKIE['gj9551']))
			{
				if($_COOKIE['gj9551'] == 'show')
